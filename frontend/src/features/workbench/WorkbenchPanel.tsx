      ...
      <aside className="w-72 border-r border-border bg-chrome flex flex-col min-h-0">
        ...
        <div className="border-t border-border p-3 space-y-2">
          ...
          {view === 'agents' ? <>
            ...
            <button className="w-full bg-accent text-accent-fg rounded py-1.5 disabled:opacity-40" disabled={!task.trim() || pending > 0} onClick={() => void startAgent()}>Start Agent</button>
          </> : <>
            ...
            <button className="w-full bg-accent text-accent-fg rounded py-1.5 disabled:opacity-40" disabled={!workflowStages.length || pending > 0} onClick={() => void startWorkflow()}>Start Workflow</button>
          </>}
        </div>
      </aside>
